<script setup>
  ...
  function revealContent() {
    ...
    if (prefersReducedMotion.value) mainTl.fromTo('.header__container__title__line__content', { opacity: 0 }, { opacity: 1, stagger: 0.175 })
    else mainTl.fromTo('.header__container__title__line__content', { yPercent: 100, opacity: 1 }, { yPercent: 0, duration: 1.5, stagger: 0.175 })
