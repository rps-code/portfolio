...
<script setup>
  ...
  function showMenu() {
    ...
    if (prefersReducedMotion.value) return (prevAnimation = gsap.fromTo(menu.value, { autoAlpha: 0 }, { autoAlpha: 1 }))
    ...
    prevAnimation.fromTo(menuBackItemLine.value, { transform: 'scaleX(0)', transformOrigin: 'left bottom' }, { transform: 'scaleX(1)', stagger: 0.05 }, '<-0.2')
    prevAnimation.fromTo(
